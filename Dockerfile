...
COPY --from=compile-image "/code/cookiecutter_demo.egg-info/" "/code/cookiecutter_demo.egg-info/"
COPY --from=compile-image "/code/cookiecutter_demo" "/code/cookiecutter_demo"
...
# Metadata
LABEL org.opencontainers.image.authors="Roel van den Berg roel.vandenberg@kadaster.nl" \
      org.opencontainers.image.created=$BUILD_DATE \
      org.opencontainers.image.title="cookiecutter-demo" \
      org.opencontainers.image.description="Demo van cookiecutter-python-base van PDOK" \
      org.opencontainers.image.url="https://github.com/PDOK/cookiecutter-demo" \
      org.opencontainers.image.vendor="PDOK" \
      org.opencontainers.image.source="https://github.com/PDOK/cookiecutter-demo" \
      org.opencontainers.image.revision=$GIT_COMMIT_HASH \
      org.opencontainers.image.version=$VERSION

ENTRYPOINT [ "demo-cookiecutter" ]